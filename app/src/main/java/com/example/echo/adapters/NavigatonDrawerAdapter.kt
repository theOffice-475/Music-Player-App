...
import com.example.echo.fragments.favorite
import com.example.echo.fragments.settingFragment

class NavigatonDrawerAdapter(_contentList: ArrayList<String>,_getImages: IntArray,_context: Context)
    : RecyclerView.Adapter<NavigatonDrawerAdapter.NavViewHolder>()
{
